package com.nestor.programacionfuncional;
...
import com.nestor.programacionfuncional.entidades.Usuario;
...
public class App 
{
	...
	public static void map() {
		...
		Set<String> nombresDistintos =usuarios.stream()
				.map(e->e.getNombre())  // se queda solo con los nombres
				.collect(Collectors.toSet()); // toSet como el toList pero sin admitir elementos repetidos
		...
		public static String convertirMayusculas(String nombre) {
			...
			try {
				Thread.sleep(1000);  // Duerme 1 segundo el procesador. Como tenemos 8 usuarios (8 elementos) tarda 1 segundo para cada 1.
